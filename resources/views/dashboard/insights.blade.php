...
@section('meta_description', 'View your portfolio insights and statistics')

@section('meta_keywords', 'insights, statistics, analytics, portfolio metrics')
...
@section('content')
    <div style="padding: 2rem;">
        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); margin-bottom: 2rem;">
            <h2 style="color: var(--blue); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">
                <i class="fas fa-chart-line"></i> Insights & Statistics
            </h2>
            <p style="color: #666;">Overview of your portfolio performance and metrics</p>
        </div>
        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); margin-bottom: 2rem;">
            ...
            @if ($recentProjects->isEmpty())
                <p style="color: #999; text-align: center; padding: 2rem;">No projects yet</p>
            @else
        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            @if ($recentReviews->isEmpty())
                <p style="color: #999; text-align: center; padding: 2rem;">No reviews yet</p>
            @else
